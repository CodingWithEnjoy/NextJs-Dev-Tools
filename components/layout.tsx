        ...
        {panelVisibility.footer && (
          <>
            <blockquote className={styles.blockquote}>
              ...
              <span>BAZINGA</span> is the best all-in-one toolbox for all
              your needs ... Bazinga!
              <footer>—— Sheldon Lee Cooper</footer>
            </blockquote>
            <footer className={styles.mainFooter}>
              <nav>
                <a href="https://github.com/CodingWithEnjoy/NextJs-Dev-Tools">
                  Star on GitHub
                </a>
                <a href="https://github.com/CodingWithEnjoy/NextJs-Dev-Tools/issues/new">
                  Report a Bug
                </a>
